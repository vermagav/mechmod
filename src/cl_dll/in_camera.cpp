...
// pitch, yaw, dist
vec3_t cam_ofs;
// Added by Pcjoe, global camera angles
...
void DLLEXPORT CAM_Think( void )
{
	...
	// Added by Pcjoe, record camera angles
	g_CameraAngles = camAngles;
	g_CameraAngles.z = 0;
}
...
{ 
	...
	// removed by Pcjoe, we want third person
/*
#if !defined( _DEBUG )
...
void CAM_Init( void )
{
	...
	cam_idealdist			= gEngfuncs.pfnRegisterVariable ( "cam_idealdist", "40", 0 );	 // thirdperson distance
	cam_contain				= gEngfuncs.pfnRegisterVariable ( "cam_contain", "0", 0 );	// contain camera to world
	// Added by Pcjoe
	cam_xoffset				= gEngfuncs.pfnRegisterVariable ( "cam_xoffset", "0", FCVAR_ARCHIVE );	// x offset
	cam_yoffset				= gEngfuncs.pfnRegisterVariable ( "cam_yoffset", "10", FCVAR_ARCHIVE );	// y offset
