...
// Added by Pcjoe
cvar_t	*cl_sabercollision;
cvar_t	*cl_sabertrails;
cvar_t	*cl_crosshair;
// Added by Jason 1-18-04
cvar_t	*cl_gltextures;
cvar_t	*cl_texres;
cvar_t	*cl_shelllife;
cvar_t	*cl_cgglow;
cvar_t	*cl_glglow;
cvar_t	*cl_cgglowall;
cvar_t	*cl_cgwater;
cvar_t	*cl_cgclipwater;
cvar_t	*cl_glshadows;
cvar_t	*cl_glwaterblur;
/*
===============================================================================
...
// Pcjoe: Radar
void IN_Radar(void) {gHUD.m_Radar.m_blRadar = !gHUD.m_Radar.m_blRadar;}
...
// Edited by Pcjoe, apply move up/down to jump / duck key
...
void InitInput (void)
{
	...
	// Pcjoe: Radar key
	gEngfuncs.pfnAddCommand ("radar",IN_Radar);
	...
	// Added by Pcjoe
	cl_sabercollision	= gEngfuncs.pfnRegisterVariable ( "cl_sabercollision", "1", FCVAR_ARCHIVE );
	cl_sabertrails		= gEngfuncs.pfnRegisterVariable ( "cl_sabertrails", "1", FCVAR_ARCHIVE );
	cl_crosshair		= gEngfuncs.pfnRegisterVariable ( "cl_crosshair", "1", FCVAR_ARCHIVE );
	// Added by Jason
	cl_gltextures		= gEngfuncs.pfnRegisterVariable ( "cl_gltextures", "1", FCVAR_ARCHIVE );
	cl_texres			= gEngfuncs.pfnRegisterVariable ( "cl_gltexres", "1", FCVAR_ARCHIVE );
	cl_shelllife		= gEngfuncs.pfnRegisterVariable ( "cl_shelllife", "5", FCVAR_ARCHIVE );
	cl_cgglow			= gEngfuncs.pfnRegisterVariable ( "cg_blur_steps", "0", FCVAR_ARCHIVE );
	cl_glglow			= gEngfuncs.pfnRegisterVariable ( "cl_glglow", "0", FCVAR_ARCHIVE );
	cl_cgglowall		= gEngfuncs.pfnRegisterVariable ( "cg_glow_all", "1", FCVAR_ARCHIVE );
	cl_cgwater			= gEngfuncs.pfnRegisterVariable ( "cg_water", "0", FCVAR_ARCHIVE );
	cl_cgclipwater		= gEngfuncs.pfnRegisterVariable ( "cg_clipwater", "0", FCVAR_ARCHIVE );
	cl_glshadows		= gEngfuncs.pfnRegisterVariable ( "gl_shadow", "1", FCVAR_ARCHIVE );
	cl_glwaterblur		= gEngfuncs.pfnRegisterVariable ( "gl_waterblur", "1", FCVAR_ARCHIVE );
