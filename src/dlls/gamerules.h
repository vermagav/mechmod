...
// Pcjoe, gamemode types
#define GAMEMODE_DEATHMATCH	0
#define GAMEMODE_TEAMPLAY	1
#define GAMEMODE_SEIGE		2
...
// Functions to verify the single/multiplayer status of a game
	...
	virtual BOOL IsSeige( void ) { return FALSE; };	// are we playing a game of seige
	virtual BOOL IsCoOp( void ) = 0;// is this a coop game?
	virtual const char *GetGameDescription( void ) { return "Mech Mod"; }  // this is the game name that gets seen in the server browser
