...
extern CBaseEntity	*UTIL_EntityByIndex( int idx );
...
// Pcjoe: Set Model
extern void			UTIL_SetModel( const char *pModel, entvars_t *pev );
extern void			UTIL_SetPlayerModel( const char *pModel, entvars_t *pev );

// Pcjoe: Lock Model
extern void			UTIL_LockModelAngles( CBaseEntity *pEnt, BOOL fLock );
...
#define VEC_HUMAN_HULL_MAX	Vector( 8, 8, 18 )
